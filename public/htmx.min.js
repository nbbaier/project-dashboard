var htmx = (() => {
	...
	const H = r.map((e) => "[hx-" + e + "], [data-hx-" + e + "]").join(", ");
	function d(e) {
		if (e == undefined) {
			return undefined;
		}
	...
	function Se(e, t) {
		return ue(o(e, (e) => te(ue(e), t) != null));
	}
	function Ee(e) {
	...
	function qe(e) {
		se(x(e, "[hx-preserve], [data-hx-preserve]"), (e) => {
			const t = te(e, "id");
	...
	function $e(e, t, r, o) {
		...
		if (r.swapStyle === "textContent") {
			...
			if (o.select) {
				...
				se(n.querySelectorAll(o.select), (e) => {
					d.appendChild(e);
				});
				n = d;
			}
				...
				if (t.handledFor.indexOf(l) < 0) {
					...
					if (u.throttle > 0) {
						if (!f.throttle) {
							he(l, "htmx:trigger");
							c(l, e);
							f.throttle = E().setTimeout(() => {
								f.throttle = null;
							}, u.throttle);
						}
					} else if (u.delay > 0) {
						f.delayed = E().setTimeout(() => {
							he(l, "htmx:trigger");
							c(l, e);
						}, u.delay);
					} else {
	...
	function _t(e) {
		...
		se(x(n, "[data-disabled-by-htmx]"), (e) => {
	...
	function on(t, n, r, o, i) {
		...
		if (tn(o)) {
			...
			if (o instanceof HTMLSelectElement && o.multiple) {
				e = M(o.querySelectorAll("option:checked")).map((e) => e.value);
			}
	...
	function de(t, n, r, o, i, D) {
		...
		var T = Zt(r);
		var q = Yt(r);
		se(["loadstart", "loadend", "progress", "abort"], (t) => {
			se([p, p.upload], (e) => {
	...
	function Dn(o, i) {
		...
		if (m.shouldSwap) {
			...
			var x = gn(o, g);
			if (!Object.hasOwn(x, "ignoreTitle")) {
				x.ignoreTitle = h;
			}
	...
	var jn = false;
	ne().addEventListener("DOMContentLoaded", () => {
		jn = true;
	});
	function Vn(e) {
